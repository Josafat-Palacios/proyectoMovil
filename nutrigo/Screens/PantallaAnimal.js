...
const PantallaAnimal = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
       <Header
            ...
            centerComponent={{ text: 'Origen Animal' , style: { color: 'black', fontSize:20, fontWeight: 'bold' }}}
            ...
            containerStyle={{backgroundColor:'#D4ADC2'}}
        />
        
        <View style={styles.headerContainer}>
        <Text style={styles.headerTextCenter}>
          Energía: 40 kcal | Grasas: 1 g
        </Text>
        <Text style={styles.headerTextCenter}>
          Hidratos de Carbono: 0 | Proteínas: 7 g
        </Text>
      </View>
