...
const PantallaFrutas = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
       <Header
            ...
            centerComponent={{ text: 'Frutas' , style: { color: 'black', fontSize:20, fontWeight: 'bold' }}}
            rightComponent={{ icon: 'add-circle-outline', color: 'white', onPress:()=>{
                 setAlimento({
                     id:null,
                     nombre:"",
                     cantidad:"",
            ...
            containerStyle={{backgroundColor:'#BB271A'}}
        />
        
        <View style={styles.headerContainer}>
        <Text style={styles.headerTextCenter}>
          Energía: 60 kcal | Grasas: 0 g
        </Text>
        <Text style={styles.headerTextCenter}>
          Hidratos de Carbono: 15 | Proteínas: 0 g
        </Text>
      </View>
