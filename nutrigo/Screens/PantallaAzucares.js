...
const PantallaAzucares = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
       <Header
            ...
            centerComponent={{ text: 'Azucares' , style: { color: 'black', fontSize:20, fontWeight: 'bold' }}}
        ...
        <Text style={styles.headerTextCenter}>
          Energía: 40 kcal | Grasas: 0 g
        </Text>
        <Text style={styles.headerTextCenter}>
          Hidratos de Carbono: 10 | Proteínas: 0 g
        </Text>
      </View>
...
export default PantallaAzucares
